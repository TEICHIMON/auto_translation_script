...
# Determine target voice from folder name (edge-tts mode)
get_target_voice() {
    local name="$1"
...
$USE_OPENAI && log "🤖 Engine: OpenAI" || log "🎤 Engine: edge-tts"
